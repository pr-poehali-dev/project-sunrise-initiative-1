        ...
        <div className="relative z-10 pt-28 flex flex-col">
          ...
          <div className="w-full flex justify-center px-6 mt-16">
            <div className="w-full max-w-4xl">
              ...
              >
                Контролируй деньги. Планируй будущее.
              </motion.h1>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                Финансовый трекер для iPhone — фиксируй расходы, ставь цели
                <br />
                и видь полную картину своих финансов в одном месте.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <button className="px-5 py-2.5 bg-emerald-500 text-white font-medium rounded-lg hover:bg-emerald-400 transition-colors text-sm">
                  Попробовать бесплатно
                </button>
                <button className="text-zinc-300 font-medium hover:text-white transition-colors flex items-center gap-2 text-sm">
                  <span className="text-zinc-500">Новинка:</span> Умный анализ трат с ИИ
